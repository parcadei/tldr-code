...
//! - Tests stripped
//! - DFT_TINY_THRESHOLD env var replaced with constant

use std::hash::Hash;

use super::changes::{insert_deep_unchanged, ChangeKind, ChangeMap};
use super::hash::DftHashSet;
use super::lcs_diff;
use super::syntax::{ContentId, Syntax};
...
fn split_unchanged<'a>(
    ...
    let size_threshold = TINY_TREE_THRESHOLD;
